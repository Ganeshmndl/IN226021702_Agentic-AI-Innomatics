...
def sort_products(
    ...
    sorted_products = sorted(
        products, key=lambda p: p[sort_by], reverse=reverse)
    return {
        'sort_by':  sort_by,
        'order':    order,
...
# This API shows orders in pages so users can view them step by step.
# Paginate orders list (same logic as products pagination)
